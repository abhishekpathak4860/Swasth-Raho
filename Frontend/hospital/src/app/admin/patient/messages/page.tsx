...
export default function PatientMessagesPage() {
  ...
  const playSendSound = () => {
    sendSoundRef.current?.play().catch((e) => console.log(e));
  };

  const playReceiveSound = () => {
    receiveSoundRef.current?.play().catch((e) => console.log(e));
  };
  ...
  return (
    // Height calculation: Subtract header/padding of parent layout if needed,
    // but h-[calc(100vh-theme(spacing.16))] is generally safe for nested layouts.
    // Assuming the parent main container has padding, h-full works best.
        ...
        <div className="p-4 border-b bg-gray-50/50">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-white border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 outline-none text-black"
            />
          </div>
        </div>
            ...
            filteredDoctors.map((doc) => (
              ...
              >
                <div className="relative shrink-0">
                  <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center overflow-hidden border border-blue-200">
                    {doc.profileImg ? (
                      <img
                        src={doc.profileImg}
